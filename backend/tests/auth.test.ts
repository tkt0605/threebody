...
describe('resolveUserId', () => {
  const saved = { url: process.env.VITE_SUPABASE_URL, key: process.env.SUPABASE_SECRET_KEY }

  afterEach(() => {
    for (const [name, value] of [['VITE_SUPABASE_URL', saved.url], ['SUPABASE_SECRET_KEY', saved.key]] as const) {
